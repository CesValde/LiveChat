...
const box = document.getElementById('box')          // input del chat
const app = document.getElementById('app-chat')     // div con los <p> mensajes <p>
...
// emite el mensaje enviado del usuario
